...
The order of properties is important the property which comes later in the order
get the precedence so if we are using a spread operator(user migh have used some
property ) then it should generally come at the end.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=saqlainkhan25%40gmail.com).
